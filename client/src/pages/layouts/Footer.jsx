    ...
    <div className="bg-[#222]">
        ...
        <div className="flex flex-col gap-[60px]">
            ...
            <div className="flex gap-8 items-center">
              ...
              <div className="flex gap-6 leading-4">
                <div className="p-3 rounded-full cursor-pointer transition-colors duration-500 ease-in-out hover:bg-white/5">
                  ...
                  >
                    <g clip-path="url(#clip0_1087_1705)">
                      <path
                ...
                <div className="p-3 rounded-full cursor-pointer transition-colors duration-500 ease-in-out hover:bg-white/5">
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <g clip-path="url(#clip0_1087_1715)">
                      <path
                ...
                <div className="p-3 rounded-full cursor-pointer transition-colors duration-500 ease-in-out hover:bg-white/5">
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <g clip-path="url(#clip0_1087_1707)">
                      <path
                ...
                <div className="p-3 rounded-full cursor-pointer transition-colors duration-500 ease-in-out hover:bg-white/5">
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <g clip-path="url(#clip0_1087_1712)">
                      <path
            ...
            <div className="flex flex-col">
              ...
              <div className="flex gap-[13px] items-center opacity-70 text-white">
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clip-path="url(#clip0_1087_3645)">
                    <path
              ...
              <div className="flex gap-[13px] items-center opacity-70 text-white">
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clip-path="url(#clip0_1087_3652)">
                    <path
          ...
          <div className="flex justify-between items-center py-5 text-sm text-white/70 border-t border-white/[0.07]">
            ...
            <div className="flex gap-5">
              <select className="bg-white/5 px-5 py-3 rounded" value="0">
      ...
      >
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <g clip-path="url(#clip0_1087_3677)">
            <path
